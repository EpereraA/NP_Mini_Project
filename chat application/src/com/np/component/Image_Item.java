...
import com.np.event.EventFileReceiver;
import com.np.event.EventFileSender;
import com.np.model.Model_File_Sender;
import com.np.model.Model_Receive_Image;
import com.np.service.Service;
import com.np.swing.blurHash.BlurHash;
...
public class Image_Item extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        pic = new com.np.swing.PictureBox();
        progress = new com.np.swing.Progress();

        progress.setForeground(new java.awt.Color(255, 255, 255));
        progress.setProgressType(com.np.swing.Progress.ProgressType.CANCEL);
    ...
    private com.np.swing.PictureBox pic;
    private com.np.swing.Progress progress;
